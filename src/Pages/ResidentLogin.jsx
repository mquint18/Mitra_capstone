  ...
  return (
    <div className="rl-wrap">
      <div className="rl-card">
        ...
        <p className="rl-sub">Sign in to find local businesses and book services.</p>

        {/* Server error */}
        {errors.server && (
          <div className="rl-error-banner" role="alert">{errors.server}</div>
        )}
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="rl-field">
            ...
            />
            {errors.email && (
              <span className="rl-field-error" role="alert">{errors.email}</span>
            )}
          </div>
          ...
          <div className="rl-field">
            <div className="rl-password-row">
              ...
              <a href="/forgot-password" className="rl-forgot">Forgot password?</a>
            </div>
            <input
              id="password"
              type="password"
            ...
            />
            {errors.password && (
              <span className="rl-field-error" role="alert">{errors.password}</span>
            )}
          </div>
        ...
        <a href="/signup" className="rl-signup-btn">Create a resident account</a>
